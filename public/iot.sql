...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 13, 2017 lúc 01:29 AM
...
--INSERT INTO `config` (`SSID`, `SSID_Password`, `Sensor_Freq`, `Sensor_t`, `Sensor_h`) VALUES('Xom Tro', 'sqtt2016', 1, 30, 80);
...
//INSERT INTO `data` (`Time`, `h`, `t`) VALUES('2017-12-11 13:35:38', 9, 10);
COMMIT;
